...
enum FoFiType1CEncodingType {
	FoFiType1CEncodingTypeNone,
	FoFiType1CEncodingTypeStandard,
	FoFiType1CEncodingTypeExpert,
	FoFiType1CEncodingTypeUser
};
...
private:
  ...
  void eexecWriteCharstring(Type1CEexecBuf *eb, const Guchar *s, int n);
  GBool parse();
  void readTopDict();
  ...
  GooString *name;
  char **encoding;
	FoFiType1CEncodingType encodingType;
