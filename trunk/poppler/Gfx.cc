...
GBool GfxResources::lookupMarkedContentNF(const char *name, Object *obj) {
  GfxResources *resPtr;
...
GfxPattern *GfxResources::lookupPattern(const char *name, Gfx *gfx) {
  GfxResources *resPtr;
  GfxPattern *pattern;
  Object obj;
...
GfxShading *GfxResources::lookupShading(const char *name, Gfx *gfx) {
  GfxResources *resPtr;
  GfxShading *shading;
  Object obj;
...
GBool GfxResources::lookupGStateNF(const char *name, Object *obj) {
  GfxResources *resPtr;
...
void Gfx::doShowText(GooString *s) {
  ...
  if (font->getType() == fontType3 && out->interpretType3Chars()) {
    ...
    newCTM[3] = mat[2] * oldCTM[1] + mat[3] * oldCTM[3];
	  // fix by Guangda, I think there are still bugs here
    for (i = 0; i < 4; ++i) {
      oldCTM[i] = newCTM[i];
    }
