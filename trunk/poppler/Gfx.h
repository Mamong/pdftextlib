...
public:
  ...
  GBool lookupMarkedContentNF(const char *name, Object *obj);
  void lookupColorSpace(const char *name, Object *obj);
  GfxPattern *lookupPattern(const char *name, Gfx *gfx);
  GfxShading *lookupShading(const char *name, Gfx *gfx);
  GBool lookupGState(const char *name, Object *obj);
  GBool lookupGStateNF(const char *name, Object *obj);
