...
public:
  ...
  virtual void *makeAuthData(const char *ownerPassword, const char *userPassword) = 0;
...
public:
  ...
  virtual void *makeAuthData(const char *ownerPassword, const char *userPassword);
